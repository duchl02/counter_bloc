...
abstract class $CounterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int number, StatusEnum status});
}
...
class _$_CounterState extends _CounterState {
  _$_CounterState({required this.number, required this.status}) : super._();
  ...
  @override
  String toString() {
    return 'CounterState(number: $number, status: $status)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, number, status);
...
abstract class _CounterState extends CounterState {
  factory _CounterState(
      ...
      required final StatusEnum status}) = _$_CounterState;
